# 🐂 Graph Parti Context Architecture 🔵

> **Ralph Loop Context Organizer** — Iteratively sorted using SCL zip codes
> 
...
| Order | File | Domain | Phase | Architectural Style |
|-------|------|--------|-------|---------------------|
| 🐂 | [🐂-tuscan.md](./🐂-tuscan.md) | Foundation | 1 of 7 | Simple, foundational |
| ⛽ | [⛽-doric.md](./⛽-doric.md) | Validation | 2 of 7 | Strong, structural |
| 🦋 | [🦋-ionic.md](./🦋-ionic.md) | Building | 3 of 7 | Elegant, growing |
| 🏟 | [🏟-corinthian.md](./🏟-corinthian.md) | Execution | 4 of 7 | Ornate, active |
| 🌾 | [🌾-composite.md](./🌾-composite.md) | Integration | 5 of 7 | Combined, flowing |
| ⚖ | [⚖-vitruvian.md](./⚖-vitruvian.md) | Calibration | 6 of 7 | Balanced, refined |
| 🖼 | [🖼-palladian.md](./🖼-palladian.md) | Experience | 7 of 7 | Complete, polished |
| 🧮 | [🧮-save.md](./🧮-save.md) | System | — | Always evolving |
...
```
🐂🏛📍🔵 - Subject description.parti
│ │ │ │
│ │ │ └── Color: State/status (8 options)
│ │ └──── Axis: Lens/dimension (6 options)
│ └────── Type: Action/operation (12 options)
└──────── Order: Phase/domain (7 options)
```

### Color Legend

| Color | Name | State | Use In Files |
|-------|------|-------|--------------|
| ⚪ | Eudaimonia | Clear, neutral | Baseline truth |
| 🟡 | Play | Exploring, draft | Ideas, experiments |
| 🟠 | Connection | Collaborative | Integration, teams |
| 🔴 | Passion | Urgent, priority | Critical path |
| ⚫ | Order | Complete, done | Finished items |
| 🟣 | Magnificence | Significant | Important, final |
| 🔵 | Planning | Structured | Spec'd, designed |
| 🟢 | Growth | Active, building | WIP, in progress |

### Navigation Pattern

1. Start at **🐂 Tuscan** for what things ARE
2. Check **⛽ Doric** for what must be TRUE
3. See **🦋 Ionic** for what's being BUILT
4. Understand **🏟 Corinthian** for what HAPPENS
5. Explore **🌾 Composite** for how things CONNECT
6. Refine via **⚖ Vitruvian** for BALANCE
7. Experience via **🖼 Palladian** for FINAL FORM
8. Track via **🧮 Save** for WORK IN PROGRESS
...
|------|-----------|-------|--------|
| 🐂-tuscan.md | 5 | 14 | ✅ SORTED |
| ⛽-doric.md | 6 | 16 | ✅ SORTED |
| 🦋-ionic.md | 7 | 23 | ✅ SORTED |
| 🏟-corinthian.md | 7 | 16 | ✅ SORTED |
| 🌾-composite.md | 6 | 20 | ✅ SORTED |
| ⚖-vitruvian.md | 6 | 21 | ✅ SORTED |
| 🖼-palladian.md | 8 | 26 | ✅ SORTED |
| 🧮-save.md | — | ~30 | 🔄 ACTIVE |
